...
_.unique = function(arr){
    //declare empty variable array
let newArr = [];
//for each of the things in the array
for(let item of arr){
    //
...
_.partition = function(arr, func){
    ...
    //     let finalArray = [];
    //     finalArray.push(_.filter(arr, func));
    //     finalArray.push(_.reject(arr, func));
    //   return finalArray
...
_.pluck = function(collection, property){
    var newArr = [];
    _.map(collection, function(e, k, c){
...
//     let result = true
//     //if func is anything but a function
...
//     } else { 
//         //for each element in the collection, perform function
//         _.each(collection, function(e, i, a){
//             //function body: if the function ran on the array is ever false
...
else if(_.reject(collection, func).length > 0){
    //set variable result to false
    result = false;
}
//return result
...
//if any of items in collection return false from function func
else if(_.filter(collection, func).length > 0){
    //set variable result to true
    result = true;
} else {
    result = false;
...
if(seed === undefined){
    //se seed to the first value in array
    seed = array[0];
